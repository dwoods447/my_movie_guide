...
module.exports = {
  ...
  */
  axios: {
    ...
    API_HOST :process.env.port ? `https://nuxt-movie-guide-app.herokuapp.com` : `http://localhost`,
    API_URL : process.env.port ? `https://nuxt-movie-guide-app.herokuapp.com:${process.env.port}/api` : `http://localhost:3000/api`,
    API_PREFIX: '/api',
